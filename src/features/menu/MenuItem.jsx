...
import UpdateItemQuantiity from "../cart/UpdateItemQuantiity.jsx";
        ...
        <li className='flex gap-4 py-2'>
            ...
            <div className='flex flex-col grow pt-0.5 '>
                ...
                <div className='mt-auto flex flex-grow items-center justify-between '>
                    ...
                    {isInCart && <div className='flex flex-items-center gap-3 sm:gap-8'><UpdateItemQuantiity pizzaId={id} currentQuantity={currentQuantity}/> <DeleteItem pizzaId={id}/></div>}
